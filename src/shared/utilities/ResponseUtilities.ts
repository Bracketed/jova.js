...
export class ResponseUtility {
	 ...
	 * @readonly
	 */
	public readonly setHeader = (field: any, value?: string): ApplicationResponse => this.response.set(field, value);
	/**
	 * Set header `field` to `value`, or pass
	 * an object of header fields.
	 *
	 ...
	 * @readonly
	 */
	public readonly set = (field: any, value?: string): ApplicationResponse => this.response.set(field, value);
	/**
	...
	public readonly append = (field: string, value: string[] | string): ApplicationResponse =>
		this.response.appendHeader(field, value);
	/**
	 * Appends the specified value to the HTTP response header field.
	 * If the header is not already set, it creates the header with the specified value.
	 * The value parameter can be a `string` or an `array`.
	 ...
	 * @readonly
	 */
	public readonly simpleDownload = (path: string): void => this.response.download(path);
	/**
	 * Transfer the file at the given path as an attachment.
	 *
	 * Optionally providing an alternate attachment `filename`, and optional `callback fn(err)`.
